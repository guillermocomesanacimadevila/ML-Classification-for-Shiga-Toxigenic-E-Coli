...
region_counters <- read.csv("region_counters.csv", header = TRUE)
country_counters <- read.csv("country_counters.csv", header = TRUE)
stx_counters <- read.csv("stx_counters.csv", header = TRUE)
pt_counters <- read.csv("pt_counters.csv", header = TRUE)
